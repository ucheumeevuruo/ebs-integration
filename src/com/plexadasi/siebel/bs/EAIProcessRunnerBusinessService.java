...
import com.plexadasi.order.ProcRunner;
...
public class EAIProcessRunnerBusinessService extends BusinessService {
    @Override
    public void doInvokeMethod(String MethodName, SiebelPropertySet input, SiebelPropertySet output) 
        ...
        try {
            this.init(MethodName, input);
                Method method = ProcRunner.class.getMethod(MethodName, new Class[0]);
                method.invoke(new ProcRunner(connection, input, output), new Object[0]);
            }
