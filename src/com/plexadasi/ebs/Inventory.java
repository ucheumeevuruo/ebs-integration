...
public final class Inventory {
    ...
    private static final String DEFAULT_TABLE_NAME = "ITEM";
    private static final String DEFAULT_OBJECT_NAME = "ITEMS";

    public Inventory(Connection connection, List<Iinventory> inventory) {
        this(connection, inventory, DEFAULT_TABLE_NAME, DEFAULT_OBJECT_NAME);
    }

    public Inventory(Connection connection, List<Iinventory> inventory, String tableName, String objectName) {
